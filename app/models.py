...
class InventoryPurchase(TimestampMixin, db.Model):
    ...
    created_by = db.relationship("User", backref="inventory_purchases")
...
class InventoryDailyClosing(TimestampMixin, db.Model):
    ...
    inbound_amount = db.Column(db.Float, nullable=False, default=0)
    closing_stock = db.Column(db.Float, nullable=False, default=0)
    consumed_amount = db.Column(db.Float, nullable=False, default=0)
    expected_consumption_amount = db.Column(db.Float, nullable=False, default=0)
    explicit_wastage_amount = db.Column(db.Float, nullable=False, default=0)
    variance_amount = db.Column(db.Float, nullable=False, default=0)
    unexplained_variance_amount = db.Column(db.Float, nullable=False, default=0)
    variance_value = db.Column(db.Float, nullable=False, default=0)
    stock_status = db.Column(db.String(20), nullable=True)
    suggested_purchase_amount = db.Column(db.Float, nullable=False, default=0)
    note = db.Column(db.String(255), nullable=True)
